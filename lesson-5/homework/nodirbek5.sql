...
7) select iif(StockQuantity > 100, 'Yes',  'No') as StockQuantity from Products_Discounted
...
10) select iif(Price>1000, 'Expensive', 'Affordable') as PricrLevel from Products
