...
3) select Name, DepartmentName  
from Employees as E
left join Departments as D
on E.DepartmentID= D.DepartmentID

4) select  SupplierName, ProductName
from Products as P
left join Suppliers as S
on P.SupplierID=S.SupplierID

5) select O.OrderID, O.OrderDate, PaymentDate, Amount
from Orders as O
...
8)select FirstName, LastName, Quantity
from Customers as C 
left join Orders as O
on C.CustomerID=O.CustomerID
where  Quantity> 3

9) select Name as EmoloyeeName, D.DepartmentName
from Employees as E
...
13) select Name, d.DepartmentName
from Employees as e
...
16) select Name, Salary, DepartmentName
from Employees as e
left join Departments as d
on e.DepartmentID=d.DepartmentID
where  Salary> 60000
