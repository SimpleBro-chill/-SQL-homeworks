...
2) SELECT d.DepartmentName, e.Name AS EmployeeName
FROM Departments d
...
4) SELECT c.FirstName, c.LastName, o.OrderID, o.OrderDate
FROM Customers c
JOIN Orders o ON o.CustomerID = c.CustomerID;


5)SELECT s.Name AS StudentName, c.CourseName
FROM Students s
CROSS JOIN Courses c;


6)SELECT p.ProductName, o.OrderID, o.Quantity, o.OrderDate
FROM Orders o
JOIN Products p ON o.ProductID = p.ProductID;


7)SELECT e.Name AS EmployeeName, d.DepartmentName
FROM Employees e
JOIN Departments d ON e.DepartmentID = d.DepartmentID;


8)SELECT s.Name AS StudentName, en.CourseID
FROM Students s
JOIN Enrollments en ON s.StudentID = en.StudentID;


9)SELECT o.OrderID, o.CustomerID, p.PaymentID, p.Amount, p.PaymentDate
FROM Orders o
JOIN Payments p ON o.OrderID = p.OrderID;


10)SELECT o.OrderID, o.CustomerID, p.ProductName, p.Price, o.Quantity, o.TotalAmount
FROM Orders o
JOIN Products p ON o.ProductID = p.ProductID
WHERE p.Price > 100;
